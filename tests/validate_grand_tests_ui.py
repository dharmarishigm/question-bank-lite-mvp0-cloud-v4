...
"""
        ...
        try:
            ...
            async with async_playwright() as p:
                ...
                await page.get_by_role('button',name='Make available',exact=True).click()
                await expect(page.get_by_role('button',name='Hide',exact=True)).to_be_visible()
                ...
                await op.get_by_role('button',name='Create workspace',exact=True).click()
