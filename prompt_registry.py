...
For every question, include a concise, independently useful worked solution in solution, a teaching explanation in English in explanation_en, and a faithful, natural Telugu explanation in explanation_te. Both explanations are mandatory and must explain the concept, reasoning, correct answer, and why the main distractors fail. Keep each explanation focused, normally within 120 words; do not omit either language.
